...
function Booking() {
  return (
    ...
    >
      ...
      <div className="w-full max-w-[95%] sm:max-w-[90%] md:max-w-[80%] lg:max-w-[1239px] h-auto text-center px-4 sm:px-6 md:px-8">
        ...
        <div className="flex flex-col sm:flex-row gap-[12px] sm:gap-[16px] justify-center w-full max-w-[300px] sm:max-w-none mx-auto">
          <button className="h-[45px] sm:h-[48px] w-full sm:w-[140px] md:w-[150px] rounded-[6px] bg-[#D6FFD0] px-[18px] sm:px-[22px] py-[8px] sm:py-[10px] text-[14px] sm:text-[15px] md:text-[16px] leading-[19px] sm:leading-[21px] font-bold text-[#28B30E]">
            Login
          </button>
          <button className="h-[45px] sm:h-[48px] w-full sm:w-[140px] md:w-[150px] rounded-[6px] bg-[#28B30E] px-[18px] sm:px-[22px] py-[8px] sm:py-[10px] text-[14px] sm:text-[15px] md:text-[16px] leading-[19px] sm:leading-[21px] font-bold text-black">
            Book Demo
          </button>
        </div>
      </div>
